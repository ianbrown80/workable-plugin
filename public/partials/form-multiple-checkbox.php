...
/**
 * The HTML markup for the multiple checkbox inputs in the form.
 *
 * @since      1.0.0
 *
 * @package    Workable
...
?>
		...
		<div class="workable-form--field-container workable-form--field-container--checkbox <?php echo $required ? 'workable-form--required-field' : ''; ?> <?php echo $is_question ? 'workable-form--question' : ''; ?>" >
